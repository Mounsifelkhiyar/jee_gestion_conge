...
public class EmployeeEditController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session.getAttribute("username") == null) {
			...
			Employee e = employeeRepo.getEmployee(request.getParameter("matricule"));
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Employee employee = employeeRepo.getEmployee(oldEmp.getmatricule());
		employee.setmatricule(request.getParameter("matricule"));
		...
		employee.setdepartements(request.getParameter("departements"));
		employee.setRole(request.getParameter("role"));
		employee.setnbConges(Integer.parseInt(request.getParameter("nbConges")));
		employeeRepo.updateEmployee(employee, oldEmp.getmatricule());
