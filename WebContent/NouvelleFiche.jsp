			...
			<div class="col-6">
				<form class="form-signin" action="EmployeeCreateController" method="POST">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="matricule" placeholder="Code matricule" required>
					</div>
					...
					<div class="form-group">
						<label for="nbConges">Nombre de congés annuel :</label>
						<input type="number" class="form-control" name="nbConges" min="0" max="50" value="25">
					</div>
